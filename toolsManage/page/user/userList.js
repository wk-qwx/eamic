layui.use(['form','layer','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'tooltype', title: '安全工器具类别', align:'center'},
            {field: 'toolname', title: '安全工器具名称',  align:'center'},
            {field: 'item', title: '数量', align:'center'},
            {field: 'createtime', title: '生成时间', align:'center',minWidth:150},
            {field: 'filepath', title: '文件路径', align:'center',minWidth:150},
