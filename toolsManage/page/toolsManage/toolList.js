layui.use(['form','layer','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        elem: '#qrcodeList',
        url : 'http://localhost:8086/toolsManage/toolslib/getall/1/10',
        cellMinWidth : 95,
        page : true,
        height : "full-125",
        limits : [10,15,20,25],
        ...
        cols : [[
            ...
            {field: 'devicestate', title: '工器具状态', align:'center',minWidth:100},
            {field: 'lastcheck', title: '上一次检测时间', align:'center',minWidth:200},
            {field: 'newcheck', title: '下一次检测时间', align:'center',minWidth:200},
